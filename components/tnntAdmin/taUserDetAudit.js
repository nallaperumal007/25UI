      ...
      <div className={styles.mainWrapper}>
        ...
        <div className={styles.wrapper} onClick={(e) => e.stopPropagation()}>
          ...
          <div className={styles.contentWrapper}>
            ...
            if (data.role_list_old !== data.role_list_new){
                 l_display_summary += 'Role list' + ' is changed from ' + data.role_list_old+ ' to: '+ data.role_list_new + ' '   ;
            }
            if (data.employee_id_old !== data.employee_id_new){
                 l_display_summary += 'Employee ID' + ' is changed from ' + data.employee_id_old+ ' to: '+ data.employee_id_new + ' '   ;
            }
            if (data.email_id_old !== data.email_id_new){
                 l_display_summary += 'Email ID' + ' is changed from ' + data.email_id_old+ ' to: '+ data.email_id_new + ' '   ;
            }
