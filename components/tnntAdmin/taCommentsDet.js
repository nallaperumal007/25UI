...
import SampleHelper from "../../helper/tnntAdmin/taCommentsDet";

export default class TaCommentsDet extends React.Component {
  constructor(props) {
    super(props);
    const stateData = {
