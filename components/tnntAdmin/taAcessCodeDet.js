...
import SampleHelper from "../../helper/tnntAdmin/taAccessCodeDet";

export default class TaAccessCodeDet extends React.Component {
  constructor(props) {
    super(props);
    const stateData = {
    ...
    SampleHelper.getRecord(filter)
      .then((data) => {
        this.setState({
          ...
          text_access_name: data[0].access_name,
                        ...
                        <div className={styles.leftWrapper}>
                            ...
                            *
                            ...
                            {editable != false ? (
                                ...
                                <CustomInput
                                 input type="text"
                                    value={text_access_name}
                                    onChange={(e) =>
                                    this.setState({
                                        text_access_name: e.target.value,
                                    })
                                    }
                                />
                                </div>
